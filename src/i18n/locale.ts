...
const englishMessages = {
  ...
  'contextMenu.copyMessage': 'Copy Message',
  ...
  'contextMenu.newTerminal': 'New Terminal',
...
const chineseMessages: Record<TranslationKey, string> = {
  ...
  'contextMenu.copySelection': '复制所选内容',
  'contextMenu.copyMessage': '复制消息',
  'contextMenu.clearConversation': '清空会话',
  'contextMenu.open': '打开',
  'contextMenu.copyPath': '复制路径',
  'contextMenu.clearTerminal': '清空终端',
  'contextMenu.newTerminal': '新建终端',
  'contextMenu.openSettings': '打开设置',
